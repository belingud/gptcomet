...
build:
    ...
    # scripts/get_binary_path.py returns a binary path generated by gptcomet python package
    @BINARY_PATH=$(uv run scripts/get_binary_path.py); \
    if [ -z "$BINARY_PATH" ]; then \
        echo "Error: scripts/get_binary_path.py return empry"; \
        exit 1; \
    fi; \
