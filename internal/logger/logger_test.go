...
func TestLogger_LogLevels(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			level:      DebugLevel,
			logFunc:    func(l *Logger, msg string) { l.Debug("%s", msg) },
			shouldLog:  true,
			wantPrefix: "[DEBUG]",
		},
		{
		...
		},
		{
			...
			level:      InfoLevel,
			logFunc:    func(l *Logger, msg string) { l.Info("%s", msg) },
			shouldLog:  true,
			wantPrefix: "[INFO]",
		},
		{
		...
		},
		{
			...
			level:      WarnLevel,
			logFunc:    func(l *Logger, msg string) { l.Warn("%s", msg) },
			shouldLog:  true,
			wantPrefix: "[WARN]",
		},
		{
			...
			level:      ErrorLevel,
			logFunc:    func(l *Logger, msg string) { l.Error("%s", msg) },
			shouldLog:  true,
			wantPrefix: "[ERROR]",
		},
	}
